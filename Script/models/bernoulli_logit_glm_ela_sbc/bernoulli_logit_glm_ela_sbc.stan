...
generated quantities {
  int y_[n_obs] = y;
  vector[n_par] pars_;
  real lambda1_ = lambda_[1];
  real lambda86_ = lambda_[86];
  real lambda1 = lambda[1];
  real lambda86 = lambda[86];
  pars_[1] = caux_;
  pars_[2] = tau_;
  pars_[3] = lambda1_;
  pars_[4] = lambda86_;
  ...
  int ranks_[n_par] = {caux < caux_, tau < tau_, lambda1 < lambda1_, lambda86 < lambda86_, p[1] < p_[1]};
}
