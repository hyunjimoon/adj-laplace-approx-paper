...
N = 999 # num of sim and fit
L = 100 # num of posterior draw
sbc_res_me_dot01<- sbc(mod, submodelName, data = data, N = N, L = L, save_progress = delivDir)
...
N = 999 
L = 100 
sbc_res_me_sddot05<- sbc(mod, submodelName, data = data, N = N, L = L, save_progress = delivDir)
...
N = 999 
L = 100 
sbc_res_me_sddot1<- sbc(mod, submodelName, data = data, N = N, L = L, save_progress = delivDir)
...
N = 999 
L = 100 
sbc_res_me_sd1<- sbc(mod, submodelName, data = data, N = N, L = L, save_progress = delivDir)
