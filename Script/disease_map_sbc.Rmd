...
## The only difference being the value of given parameters, dgp is same, prior is the cause.
I would change priors, starting with alpha. From inv-gamma to normal, as michael did (https://betanalpha.github.io/assets/case_studies/gp_part3/part3.html).
...
accurcay: orignal > normal
speed: orignal <<< normal
giving normal prior to alpha leads to much fewer cases of divergences. purple needs to be scaled up, though.
